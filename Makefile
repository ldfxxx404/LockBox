...
help:
	...
	@echo "make console_front                   - Войти в контейнер фронтенда"
	@echo "make console_backend                 - Войти в контейнер бэкенда"
	@echo "make console_bd                      - Войти в контейнер БД"
	@echo "make console_minio                   - Войти в контейнер minio"
